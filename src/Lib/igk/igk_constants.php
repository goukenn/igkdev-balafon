...
!defined("IGK_WEBFRAMEWORK") && define("IGK_WEBFRAMEWORK", "12.19");
!defined("IGK_VERSION") && define("IGK_VERSION", IGK_WEBFRAMEWORK.".1.0725");
...
define("IGK_RELEASE_DATE", "15/07/2022");
