...
!defined("IGK_WEBFRAMEWORK") && define("IGK_WEBFRAMEWORK", "12.10");
!defined("IGK_VERSION") && define("IGK_VERSION", IGK_WEBFRAMEWORK.".0.0427");
...
define("IGK_RELEASE_DATE", "25/01/2022");
