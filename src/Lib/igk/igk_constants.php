...
!defined("IGK_WEBFRAMEWORK") && define("IGK_WEBFRAMEWORK", "12.18");
!defined("IGK_VERSION") && define("IGK_VERSION", IGK_WEBFRAMEWORK.".0.0714");
...
define("IGK_RELEASE_DATE", "22/05/2022");
