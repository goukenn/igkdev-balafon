...
{
    $p = igk_html_parent_node() ?? igk_createnotagnode();
...
function igk_html_node_include($ctrl, $view, $params = null)
{
    ...
    if ($f = igk_html_parent_node()) {
        $f->host(function () use ($ctrl, $view, $params) {
            ...
            BaseController::ViewInContext($ctrl, $cf, $params);
