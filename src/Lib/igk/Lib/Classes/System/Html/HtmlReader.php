...
final class HtmlReader extends IGKObject
{
    ...
    private static function _BindTemplate($reader, &$cnode, $template, $context)
    {
        $engine = "";
        if (is_array($template)) {
            ...
            // igk_wln(__FILE__.":".__LINE__, $template, $cnode);
        ...
        while (!$end && $reader->CanRead()) {
            ...
            switch ($v_ch) {
                ...
                case "\"":
                    ...
                    // igk_wln_e("read attribute ... ", $v_n, $v_v, $c_pos);
                    $v_n = "";
                    $v_v = "";
                    $v_sv = "";
                    $mode = 1;
                ...
                case XMLNodeType::ELEMENT:
                    ...
                    if ($context == IGK_LOAD_EXPRESSION_CONTEXT) {
                        ...
                        if ($v_tn) {
                            ...
                            $cnode = $v_tn;
                            if ($template) {
                                self::_BindTemplate($reader, $cnode, $template, $context);
