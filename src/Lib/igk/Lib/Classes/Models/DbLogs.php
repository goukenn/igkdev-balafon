...
* @property string $db_logs_createAt ="NOW()"
* @property string $db_logs_tags tags
* @property string $db_logs_updateAt ="NOW()"
...
* @method static ?self Add(string $db_logs_msg, int $db_logs_status, string $db_logs_tags, string $db_logs_createAt ="NOW()", string $db_logs_updateAt ="NOW()") add entry helper
* @method static ?self AddIfNotExists(string $db_logs_msg, int $db_logs_status, string $db_logs_tags, string $db_logs_createAt ="NOW()", string $db_logs_updateAt ="NOW()") add entry if not exists. check for unique column.
* */
