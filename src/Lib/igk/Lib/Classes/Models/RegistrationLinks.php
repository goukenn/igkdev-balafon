...
* @method static ?self Add(string|?\IGK\Models\Users $regLinkUserGuid, string $regLinkToken, int $regLinkAlive, string $regLinkActivate, string $regLinkCreate_At ="NOW()", string $regLinkUpdate_At ="NOW()") add entry helper
* @method static ?self AddIfNotExists(string|?\IGK\Models\Users $regLinkUserGuid, string $regLinkToken, int $regLinkAlive, string $regLinkActivate, string $regLinkCreate_At ="NOW()", string $regLinkUpdate_At ="NOW()") add entry if not exists. check for unique column.
* */
