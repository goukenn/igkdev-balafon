...
* @method static mixed addPhoneBookEntry(\IGK\Models\Users $user,$value,$type= IGK\System\Constants\PhonebookTypeNames::PHT_PHONE) macros function definition 
* @method static mixed deleteEntry() macros function definition 
* @method static mixed getEntries(?string $entry= null) macros function definition 
* @method static mixed getPhoneBookEntry(\IGK\Models\Users $user) macros function definition 
* @method static mixed getPhoneDetails(?\IGK\System\Database\IPhoneBookDetailVisitor $visitor= null) macros function definition 
* @method static mixed loadVCardToUser(string $file,\IGK\Models\Users $user) macros function definition 
* @method static mixed resolve($search) macros function definition 
* @method static mixed searchForEntry(string $search) macros function definition 
* @method static mixed userPhoneEntries(\IGK\Models\Users $user,?string $type= IGK\Database\Macros\PhoneBooksMacros::PHONE_DEFAULT_TEL,?string $search= null) macros function definition 
* @method static mixed userSearchPhoneEntries(\IGK\Models\Users $user,string $search,?string $type= IGK\Database\Macros\PhoneBooksMacros::PHONE_DEFAULT_TEL) macros function definition 
