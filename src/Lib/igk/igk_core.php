 ...
 * @param string $key value path to get
 * @param mixed|closure $value default value
 * @return mixed|null founded value or default 
 */
function igk_get_tab_value($tab, string $key, $value = null)
{
    if (is_object($key))
        return $value;
    if (isset($tab[$key])) {
 ...
 * - used with extract to disable error that said need to pass a reference to extract method
 * @param mixed $tab 
 * @return mixed 
 */
