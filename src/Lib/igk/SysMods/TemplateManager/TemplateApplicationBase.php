...
*/
abstract class TemplateApplicationBase extends ApplicationController{
    private $m_manifest;
    ...
    */
    public function __toString(){
        return strtolower("TemplateApplication://".$this->getName());
    }
    ///<summary></summary>
    /**
    * 
    */
    public function getDataDir(){
        return $this->getDeclaredDir().DIRECTORY_SEPARATOR.IGK_DATA_FOLDER;
    }
    ///<summary></summary>
    /**
    * 
